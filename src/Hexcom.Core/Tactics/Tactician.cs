...
public sealed class Tactician(Battle battle, UtilityModel? model = null)
{
    ...
    /// did not do and entry 091 measured the cost of. The mission is judged at departure, and a
    ...
    /// there and never went in; entry 091 has the transcript. Being in view is a rate and being
    ...
    /// ground behind it — entry 091. A marker made by ear has no facing, so it carries a
