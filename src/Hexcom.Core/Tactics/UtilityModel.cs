...
/// <c>tests/Hexcom.Core.Tests/Measured</c> and the figures are <c>docs/decisions.md</c> entry 083.
/// </para>
/// </remarks>
public sealed record UtilityModel
{
    ...
    /// first. Whatever values the set has to be a per-soldier term. Entry 083.
    /// </para>
    /// </remarks>
    ...
    /// term exists would be tuning a race. Entry 083.
    /// </para>
    /// </remarks>
