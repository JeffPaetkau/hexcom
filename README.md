...
- **And the map has been measured against its own briefing**, which turned out to say more than
  ...
  look from where you land, and the roof is the whole problem. Entry 058, and three tests hold it.
...
unwritable and a fifth sentry would be a fifth sentry standing still — entry 058.
