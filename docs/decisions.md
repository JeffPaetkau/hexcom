...
## 046 — A mission is a file of its own, and the waystation is now written down once
...
battle applies it. That is still the missing clock of entry 030 and it has not moved. And see 047,
...
## 047 — A withdrawal is achieved by walking away, because the task half of a mission is not in the rules
