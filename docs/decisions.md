...
## 088 — The followers were tagged crossing the gate, the term went dead at the rung and the briefing had faded; fixed, the squad stops at the edge of the watched ground
...
- **Being forgotten is now the second best move in the game**, and it wins the waystation blind
  ...
  the other half.
- Entry 087's status can read: the followers' half is resolved by 088; the grammar half is still
  Content's.
