...
**2026-09-12** · **Raised by** core · **For** content, view · **Status** open for view — Core's half is built, and Content's landed in 088
...
**2026-09-12** · **Raised by** core · **For** core, content, master · **Status** open — item 2 under *For Master* is the next brief; item 1, the grammar, landed in 088
...
## 088 — The file says what the squad is told, a second map is fought, and a town has no ceilings
