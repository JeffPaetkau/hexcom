...
**2026-09-08** · **Raised by** content · **For** core, view and master · **Status** open (core's half, routed into `core/objectives`); view's half answered by 046, master's by 045; the map is redrawn and the brief is done
...
## 046 — The capture can act, the window can be answered by hand, and a wall is drawn by what it does
