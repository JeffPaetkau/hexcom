...
**2026-09-09** · **Raised by** content · **For** core · **Status** resolved by 058
...
## 058 — An objective at a place: one shape, three tasks, and a mission measured in one currency
...
**For Content.** `Reconnaissance(side, place, exit, within, unnoticed)` and
...
## 059 — The two archetypes now pay their own prices, and nothing noticed
