...
**Places.** The theatre is a world called **Calder** and its industrial belt: pumping stations,
relay masts, freight sheds, water plant, one refinery. Low buildings, hard standing, perimeter
walls, sandbags where somebody improved a position eleven years ago and nobody took them away.
Content owns what actually gets built; this is a palette, not a map list.
