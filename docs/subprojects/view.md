...
Brief three. `../decisions.md` entry 082 is the reasoning and the two findings; this is the shape.
...
45 per cent shot that no click from storey 0 could have asked for. Entry 082.
