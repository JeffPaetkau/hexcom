...
entry 021 routed it to Core and Content as a finding about objectives. This job turns the outline
...
- **How you know you have won**, in terms of quantities the rules already have. The withdrawal
  ...
  is readable off `AwarenessTracker` today, and saying so is what made entry 021 worth writing.
- **What going wrong looks like**, which is where the alarm and the mission clock live. Word does
  ...
  manhunt.
- **What the ground has to offer** for the mission to be playable at all. Content is authoring a
  map format against a 70 to 105 m target (entry 007); this is where it finds out that an
  extraction needs an exit and a reconnaissance needs something worth seeing.
...
entry 021 is careful not to hand them one. Rules for objectives are Core's. If the fiction wants
