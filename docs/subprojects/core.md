...
**Out of scope.** `game/**`. Entry 005 in `../decisions.md` offers View a way to hand a side to
...
- **A blade carrier will not walk across open ground to reach you.** Greedy with one step of
  ...
  in the scoring; a limit of the search, and the first thing a deeper one would fix.
