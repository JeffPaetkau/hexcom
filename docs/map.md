...
| **Interface design** | [subprojects/interface.md](subprojects/interface.md) | `docs/interface/**` — the genre's conventions, the per-game reference files under them, and a queue of briefs View builds to; it writes no code | nothing |
